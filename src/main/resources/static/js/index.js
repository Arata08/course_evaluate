layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    function login() {
        ...
        loginHtml += '<div class="layui-form-item" style="margin-top: 20px">';
        ...
        loginHtml += '</div>';
        loginHtml += '<div class="layui-form-item">';
        loginHtml += '<label class="layui-form-label">身份</label>';
        ...
        loginHtml += ' <button class="layui-btn" style="width:230px;margin-top:15px;" lay-submit="" lay-filter="login">立即登录</button>';
        loginHtml += ' </div>';
        loginHtml += ' </div>';
        loginHtml += '</form>';
